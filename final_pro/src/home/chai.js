...
// const axiosInstance = axios.create({baseUrl: 'https://localhost:3000`,})
                ...
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        <View style={{...styles.input, }}>
                            ...
                            <TextInput style={{...styles.input_text_25, backgroundColor: "#ffffff"}}  placeholder="Nhập số bình" value={lpg12} onChangeText={e=> setLpg12(e)}/>
                        </View>
                        <View style={{...styles.input, }}>
                            <Text style={styles.input_text_25}>Bình 45 kg</Text>                        
                            <TextInput style={{...styles.input_text_25, backgroundColor: "#ffffff"}}   placeholder="Nhập số bình"  value={lpg45} onChangeText={e=> setLpg45(e)}/>
                        </View>
                        <TouchableOpacity
                        style={{...styles.btn}}
                        onPress={() => HandlerChai()}>
